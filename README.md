...
- **D. Wang**. *Predictive Modeling of NBA Player Salaries Using Machine Learning*. 2023. Available at: [https://medium.com/@dwang22/](https://medium.com/@dwang22/)

- **HoopsHype**. *NBA player salaries, rumors and stats*. Available at: [https://hoopshype.com](https://hoopshype.com)

- **National Basketball Association**. *Official NBA website and multimedia resources*. Available at: [https://www.nba.com](https://www.nba.com)

- **NBA API**. *An API client package for NBA.com data*. Available at: [https://github.com/swar/nba_api](https://github.com/swar/nba_api)

- **Stathead Basketball**. *Advanced basketball statistics and research tools*. Available at: [https://www.stathead.com/basketball/](https://www.stathead.com/basketball/)

- **The R Graph Gallery**. *Inspiration and code for R charts*. Available at: [https://www.r-graph-gallery.com](https://www.r-graph-gallery.com)

- **Wikipedia**. *2024 NBA All-Star Game*. Available at: [https://en.wikipedia.org/wiki/2024_NBA_All-Star_Game](https://en.wikipedia.org/wiki/2024_NBA_All-Star_Game)